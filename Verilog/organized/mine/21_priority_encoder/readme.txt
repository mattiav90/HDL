...
each one of the 4 encorders compute 8 bit in parallel, then the valid output
of this 4 is used and sent into another priority encoder to see which one has 
the  highest 1. 
...
do not connect combinatorial logic direcly to the output because might
crate glitches. 
